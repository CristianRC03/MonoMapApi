...
export function generateCaseEmailTemplate(lat: number, lng: number, genre: string, age: number): string {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Nuevo caso de viruela del mono detectado</h1>
            </div>
            <div class="content">
                <p>Se ha detectado una persona con viruela del mono en la siguiente ubicación:</p>
                <p><strong>Genero de la persona:</strong> ${genre}</p>
